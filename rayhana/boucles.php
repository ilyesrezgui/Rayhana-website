...
<nav id="nav-bar">
    ...
    <div class="container" style="width: 80%">
		...
		<br>
        <?php
            $query = "SELECT * FROM product where type='boucles' ORDER BY id ASC ";
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="Cart.php?action=add&id=<?php echo $row["id"]; ?>">
                            ...
                            <div class="product">
                                ...
                                <h5 style="font-size:17px;color:#AF2230" >Price: <?php echo $row["price"]; ?> DT</h5>
								<label for="quantity">Quantity </label>
                                <input type="text" name="quantity" id="quantity" value="1" style="padding:7px 25px 7px 25px;outline-color:#c5a555;border:1px solid black;border-radius:10px;">
